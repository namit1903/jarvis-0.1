    ...
    return (
        ...
        >
            <motion.div 
                ...
                transition={{ duration: 0.8 }}
            >
                <h2 className="text-3xl font-extrabold text-white mb-6 text-center">Let's Chat</h2>
<h6 className="text-gray-400 italic text-center">Do Chat with Jarvis-a developer</h6>
